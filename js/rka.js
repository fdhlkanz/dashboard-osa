...
document.addEventListener("DOMContentLoaded", async function(){
    ...
    donutData.forEach(r => {
        ...
        if(keyRka && keyMasuk){
            ...
            if(kategori === "RKA MTO") rkaMto = masuk;
        ...
        if(keyObjek && keyNilai){
            ...
            if(objek.includes("PELATIHAN")) pelatihan = nilai;
...
legend: {
    ...
    series:[{
        ...
        data:[
            ...
            { name:"RKA MTO", y:rkaMto, color:"#f59e0b" },
...
legend: {
    ...
    series:[{
        ...
        data:[
            ...
            { name:"PELATIHAN", y:pelatihan, color:"#f59e0b" },
...
/* =====================================================
   TB OUT (POS ANGGARAN) - FULL FINAL
===================================================== */
...
/* =====================================================
   DETAIL PENDIDIKAN (URAIAN_BIAYA)
   LANGSUNG PAKAI URAIAN BIAYA
===================================================== */
...
document.addEventListener("DOMContentLoaded", async function(){
    ...
    const sheetData = await getSheet("URAIAN_BIAYA");
    if(!sheetData || sheetData.length === 0){
        console.log("Sheet URAIAN_BIAYA kosong");
        return;
    }
...
/* =====================================================
   DROPDOWN TOGGLE (PENDIDIKAN ONLY)
===================================================== */
...
document.addEventListener("DOMContentLoaded", async function(){
    ...
    const sheetData = await getSheet("DETAIL_FAS"); // 🔥 GANTI DI SINI
    if(!sheetData || sheetData.length === 0){
...
function renderPrognosaChart(data){
    ...
    prognosaChart = Highcharts.chart("prognosaChart",{
        ...
        series:[
            ...
            {
                name:"consumed (per 20 Oktober 2025)",
