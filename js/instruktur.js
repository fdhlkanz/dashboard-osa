...
sheet.forEach(r => {
    ...
    switch(kategori){
        ...
        case "HLO":
            if(document.getElementById("kpiHLO")){
                document.getElementById("kpiHLO").innerText = formatNumber(volume);
            }
        break;

        case "HL":
            if(document.getElementById("kpiHL")){
                document.getElementById("kpiHL").innerText = formatNumber(volume);
            }
        break;

        case "HLL":
            if(document.getElementById("kpiHLL")){
                document.getElementById("kpiHLL").innerText = formatNumber(volume);
            }
        break;

        case "HLT":
            if(document.getElementById("kpiHLT")){
                document.getElementById("kpiHLT").innerText = formatNumber(volume);
            }
        break;

        case "SME":
            if(document.getElementById("kpiSME")){
                document.getElementById("kpiSME").innerText = formatNumber(volume);
            }
        break;

        case "JUMLAH JP":
            if(document.getElementById("kpiJumlahJP")){
